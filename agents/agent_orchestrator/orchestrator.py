...
class OrchestratorAgent:
    ...
    def _build_chain(self):
        ...
        template = (
            ...
            "- reasoning_agent: questions evaluating deductive logic, inductive reasoning, syllogisms, premise validation, riddle solving, critical thinking.\n"
            "- cognitive_agent: questions evaluating pattern recognition, numerical/spatial sequences, working memory, attention to detail, sequence recall.\n\n"
            "CRITICAL INSTRUCTIONS:\n"
            "- Categorize each question into the agent domain it most strongly evaluates.\n"
            "- Output ONLY a valid JSON object matching the required schema.\n"
            "- Do NOT include any conversational preamble, commentary, or text outside the JSON.\n\n"
            "Input Q&A JSON:\n"
            "{qa_json}\n\n"
            "{format_instructions}\n"
        )
